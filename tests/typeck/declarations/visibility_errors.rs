...
#[test]
fn private_class_cross_module() { compile_should_fail_with(r#"import mod1
fn main(){let c=mod1.PrivateClass{}}"#, "unknown class 'mod1.PrivateClass'"); }

// Private function called cross-module - module system allows non-existent module, error at usage
#[test]
fn private_fn_cross_module() { compile_should_fail_with(r#"import mod1
fn main(){mod1.private_fn()}"#, "undefined variable 'mod1'"); }
...
#[test]
fn pub_in_private_module() { compile_should_fail_with(r#"import private_mod
fn main(){let c=private_mod.PublicClass{}}"#, "unknown class 'private_mod.PublicClass'"); }
...
#[test]
fn reexport_private() { compile_should_fail_with(r#"import mod1
pub use mod1.PrivateClass
fn main(){}"#, "expected"); }
