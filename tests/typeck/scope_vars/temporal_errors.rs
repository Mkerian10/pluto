//! Temporal ordering and initialization errors - 8 enabled, 2 still ignored
#[path = "../common.rs"]
mod common;
...
// Initialization in wrong order (mutual recursion)
#[test]
#[ignore] // Test is obsolete: mutual recursion is now allowed in Pluto
...
#[test]
#[ignore] // Test bug: syntax error due to missing newlines between statements
