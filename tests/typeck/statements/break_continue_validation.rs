...
#[test]
fn continue_in_while_valid() { compile_and_run(r#"fn main(){let mut i=0
while i<2{i=i+1
if i==1{continue}}}"#); }

// Break in nested loops (inner break doesn't affect outer)
#[test]
fn nested_break() { compile_and_run(r#"fn main(){let mut i=0
while i<2{while true{break}i=i+1}}"#); }

// Continue in nested loops
#[test]
fn nested_continue() { compile_and_run(r#"fn main(){let mut i=0
while i<2{let mut j=0
while j<2{if j==1{j=j+1
continue}
j=j+1}
i=i+1}}"#); }
...
#[test]
fn break_in_spawn() { compile_and_run(r#"fn f() int{while true{break}return 1}
fn main(){let t=spawn f()
print(t.get())}"#); }
