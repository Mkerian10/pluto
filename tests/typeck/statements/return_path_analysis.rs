...
// Match not exhaustive for return - correctly detected
#[test]
...
fn match_wildcard_missing_return() { compile_should_fail_with(r#"enum E{A B} fn f()int{match E.A{E.A{return 1}_{let x=2}}}"#, "Codegen error"); }
