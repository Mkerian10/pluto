...
#[test]
#[ignore] // Syntax error: bare nested blocks not supported
fn access_nested_block() { compile_should_fail_with(r#"fn main(){{let x=1}let y=x}"#, "undefined"); }
...
#[test]
#[ignore] // Test broken: catches "Task handle must be used" before "undefined variable x"
fn access_spawn_scope() { compile_should_fail_with(r#"fn f(){let x=1} fn main(){spawn f() let y=x}"#, "undefined"); }
